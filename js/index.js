...
const documentReady = () => {
  ...
  const nowZomosNobios = () => {
    alert('💞 AHORA, YA SABES QUIEN ME GUSTA💞');
    alert('😱QUE EMOCIONNNNNN!!!😱');
    location.href = 'https://www.youtube.com/watch?v=arj6eT77hzE&ab_channel=Corridosmusica';
  };
  ...
  const partner = prompt('🥰 ESCRIBI TU NOMBREEEEEEE??? 🥰');
